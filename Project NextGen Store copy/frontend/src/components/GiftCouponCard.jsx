			...
			<div className='space-y-4'>
				<div>
					...
					<input
						type='text'
						id='voucher'
						className='block w-full rounded-lg border border-gray-600/50 bg-gray-700/50 
            p-2.5 text-sm text-white placeholder-gray-400 focus:border-neon-blue 
            focus:ring-neon-blue/50 ring-2 transition-all duration-200'
